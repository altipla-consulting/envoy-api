...
func (*Alts) Descriptor() ([]byte, []int) {
	return fileDescriptor_alts_4f08e60f0a16a0c8, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/transport_socket/alts/v2alpha/alts.proto", fileDescriptor_alts_4f08e60f0a16a0c8)
}

var fileDescriptor_alts_4f08e60f0a16a0c8 = []byte{
