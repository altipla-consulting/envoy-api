...
import v2 "github.com/altipla-consulting/envoy-api/envoy/data/accesslog/v2"
...
func (*StreamAccessLogsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_als_fabf4dce79b777c6, []int{0}
}
...
func (*StreamAccessLogsMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_als_fabf4dce79b777c6, []int{1}
}
...
func (*StreamAccessLogsMessage_Identifier) Descriptor() ([]byte, []int) {
	return fileDescriptor_als_fabf4dce79b777c6, []int{1, 0}
}
...
func (*StreamAccessLogsMessage_HTTPAccessLogEntries) Descriptor() ([]byte, []int) {
	return fileDescriptor_als_fabf4dce79b777c6, []int{1, 1}
}
...
func (*StreamAccessLogsMessage_TCPAccessLogEntries) Descriptor() ([]byte, []int) {
	return fileDescriptor_als_fabf4dce79b777c6, []int{1, 2}
}
...
func init() {
	proto.RegisterFile("envoy/service/accesslog/v2/als.proto", fileDescriptor_als_fabf4dce79b777c6)
}

var fileDescriptor_als_fabf4dce79b777c6 = []byte{
