...
func (*LoadStatsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_lrs_41aba01cd4737b46, []int{0}
}
...
func (*LoadStatsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_lrs_41aba01cd4737b46, []int{1}
}
...
func init() {
	proto.RegisterFile("envoy/service/load_stats/v2/lrs.proto", fileDescriptor_lrs_41aba01cd4737b46)
}

var fileDescriptor_lrs_41aba01cd4737b46 = []byte{
