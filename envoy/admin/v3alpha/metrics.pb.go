...
func (SimpleMetric_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_464767819c666c8f, []int{0, 0}
}

// Proto representation of an Envoy Counter or Gauge value.
type SimpleMetric struct {
	// Type of the metric represented.
	Type SimpleMetric_Type `protobuf:"varint,1,opt,name=type,proto3,enum=envoy.admin.v3alpha.SimpleMetric_Type" json:"type,omitempty"`
...
func (*SimpleMetric) Descriptor() ([]byte, []int) {
	return fileDescriptor_464767819c666c8f, []int{0}
}
...
func init() {
	proto.RegisterEnum("envoy.admin.v3alpha.SimpleMetric_Type", SimpleMetric_Type_name, SimpleMetric_Type_value)
	proto.RegisterType((*SimpleMetric)(nil), "envoy.admin.v3alpha.SimpleMetric")
}

func init() { proto.RegisterFile("envoy/admin/v3alpha/metrics.proto", fileDescriptor_464767819c666c8f) }

var fileDescriptor_464767819c666c8f = []byte{
	...
	0x06, 0xf6, 0xa7, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xf4, 0x0e, 0x35, 0xd6, 0x0c, 0x01, 0x00,
	0x00,
}
